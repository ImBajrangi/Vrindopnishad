...
export function TypingAnimation({
  ...
  const MotionComponent = (motionElements[Component] || motion.span) as TypingAnimationMotionComponent;
  ...
  return (
    ...
    >
      ...
      {shouldShowCursor && (
        <span
          className={cn("inline-block opacity-75 animate-pulse ml-0.5", blinkCursor && "animate-pulse")}
        >
          {getCursorChar()}
        </span>
      )}
